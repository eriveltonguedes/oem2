...
PUBLICO  <- read_excel("INVESTIMENTO_PUBLICO.xlsx")
EDUCACAO <- read_excel("INVESTIMENTO_EDUCACAO.xlsx")
SAUDE    <- read_excel("INVESTIMENTO_SAUDE.xlsx")
...
write.csv2(dados_saude,"../resultados/dados_saude.csv")

################################################################################################
################## DADOS Pï¿½BLICO   ############################################################
################################################################################################

# Elimina uma coluna que não serïa usada
...
write.csv2(dados_publico,"../resultados/dados_publico.csv")
...
write.csv2(dados_educacao,"../resultados/dados_educacao.csv")